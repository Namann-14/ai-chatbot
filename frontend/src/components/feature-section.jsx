...
export function FeatureSection() {
  return (
    (<div
      className="grid grid-cols-1 lg:grid-cols-3 gap-4 max-w-9xl mx-auto w-full bg-transparent">
      <WobbleCard
        ...
        <Image
          ...
          className="absolute -right-0  grayscale filter -bottom-10 object-contain rounded-2xl" />
      </WobbleCard>
      ...
      <WobbleCard
        ...
        <Image
          ...
          height={200}
          alt="linear demo image"
          className="absolute right-9 -bottom-0 object-contain rounded-2xl" />
      </WobbleCard>
    </div>)
  );
}
